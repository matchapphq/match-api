interface DataExportRequestData {
  traceId?: string;
  userId?: string;
  userName?: string;
  userEmail?: string;
...
export const getDataExportRequestTemplate = (data: DataExportRequestData): string => {
...
<head>
  ...
  <title>Demande export RGPD</title>
  <style>
    body {
...
<body>
  <h2>Nouvelle demande d&apos;export de données RGPD</h2>
  <p>Une nouvelle demande d&apos;export a été envoyée depuis l&apos;application Match.</p>
